...
class Agentk8 < Formula
  ...
  url "https://registry.npmjs.org/agentk8/-/agentk8-2.1.4.tgz"
  sha256 "ee6cd92bd1b8e4ad015b907d416f687b2502e3e0563c4eebfc2661e0b9243eec"
  license "MIT"
  ...
  test do
    assert_match "2.1.4", shell_output("#{bin}/agentk8 --version")
  end
end
