...
class Agentk8 < Formula
  ...
  url "https://registry.npmjs.org/agentk8/-/agentk8-2.1.1.tgz"
  sha256 "59a82063dc6a16fef13948751c445b829609611e"
  license "MIT"
  ...
  test do
    assert_match "2.1.1", shell_output("#{bin}/agentk --version")
  end
end
